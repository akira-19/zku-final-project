...
echo "Compiling Ghosts.circom..."

# compile circuit

circom Ghosts.circom --r1cs --wasm --sym -o .
snarkjs r1cs info Ghosts.r1cs

# Start a new zkey and make a contribution

snarkjs groth16 setup Ghosts.r1cs powersOfTau28_hez_final_10.ptau circuit_0000.zkey
